...
module_dir = os.path.join(__location__, "../src/otoole")
try:
...
try:
    from otoole import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "otoole Documentation", "Will Usher", "manual")
]
