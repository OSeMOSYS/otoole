...
If you experience bugs or general issues with ``otoole``, please have a look
...
You can help improve ``otoole`` docs by making them more readable and coherent, or
...
#. Install |pre-commit|_::
   ...
   ``otoole`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/OSeMOSYS/otoole
.. _issue tracker: https://github.com/OSeMOSYS/otoole/issues
.. <-- end -->
